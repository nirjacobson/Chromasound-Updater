...
const Chromasound Chromasound::ChromasoundNovaDirect(128, true, "csnova-direct.bin", QByteArray("\x1e\x95\x16", 3), 0xEE, 0xD8, 0xF7);
const Chromasound Chromasound::ChromasoundPro(256, false, "cspro.bin", QByteArray("\x1e\x96\x0a", 3), 0xE6, 0xD8, 0xFF);
const Chromasound Chromasound::ChromasoundProDirect(256, true, "cspro-direct.bin", QByteArray("\x1e\x96\x0a", 3), 0xE6, 0xD8, 0xFF);
